...
SCHEDULE_OPTIONS: list[tuple[str, str, str]] = [
    ...
    ("🌅 Daily at 6:00 AM", "0 6 * * *", "daily_6am"),
    ("🌞 Daily at 9:00 AM", "0 9 * * *", "daily_9am"),
    ("🌆 Daily at 6:00 PM", "0 18 * * *", "daily_6pm"),
    ("🌙 Daily at 9:00 PM", "0 21 * * *", "daily_9pm"),
    ("📅 Every Monday 9 AM", "0 9 * * 1", "weekly_monday"),
    ("📅 Every Wednesday 9 AM", "0 9 * * 3", "weekly_wednesday"),
    ("📅 Every Friday 9 AM", "0 9 * * 5", "weekly_friday"),
